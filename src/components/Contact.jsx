    ...
    <section id="contact" className="bg-[#0e1419] border-t border-[#1a2332] px-4 md:px-16 py-20">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-[#00e5ff] text-[9px] tracking-[0.2em] uppercase">04. contact</span>
        </div>
          ...
          <div className="flex flex-col gap-4">
            {contactLinks.map(({ icon, label, url }) => (
              <a key={label} href={url} target="_blank" rel="noreferrer"
                className="flex items-center gap-3 text-[11px] text-[#8892a4] no-underline hover:text-[#00e5ff] transition-colors group">
                <div className="w-8 h-8 border border-[#1a2332] flex items-center justify-center text-[#00e5ff] text-sm shrink-0 group-hover:border-[#00e5ff] transition-colors">
