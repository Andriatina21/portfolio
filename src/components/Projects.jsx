...
const projects = [
  ...
  {
    id: 3,
    title: 'Projet au sein du groupe ENAC',
    description: "Refonte d'une application web",
    private: true,
    github: '',
    tools: [
      { name: 'Vue.js', logo: 'devicon-vuejs-plain colored' },
      { name: 'Laravel', logo: 'devicon-laravel-plain colored' },
    ],
    images: [
      '/projects/Stage/img1.png',
    ],
  },
  {
    id: 4,
    title: 'AutoLuxe',
    description: 'Application desktop pour la gestion de vente des voitures.',
    tools: [
  ...
  },
  {
    id: 5,
    title: 'Mobile money',
    description: 'Application pour gérer la mobile money, envoyer ou recevoir de l\'argent.',
    tools: [
  ...
  },
  {
    ...
    description: 'Une application web dédiée à la gestion de banque, plateforme centralisée permettant de superviser les opérations financières.',
    tools: [
  ...
  },
  {
    ...
    description: "Une application web dédiée à la gestion de pension permettant d'automatiser le suivi des affiliés, les calculs de droits et les versements.",
    tools: [
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        {project.private && (
          <div className="flex items-center gap-1.5 mb-2">
            <i className="ti ti-lock text-[#4a5568] text-xs" aria-hidden="true" />
            <span className="text-[8px] text-[#4a5568] tracking-widest uppercase">Projet confidentiel</span>
          </div>
        )}
        ...
        {/* ✅ Bouton conditionnel */}
        {project.private ? (
          <div className="flex items-center justify-center gap-2 border border-[#1a2332] text-[#4a5568] py-2 text-[10px] tracking-widest uppercase cursor-not-allowed select-none">
