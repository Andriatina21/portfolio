export default function Hero() {
  return (
    <section id="home" className="min-h-screen flex flex-col bg-[#080c10]">
      ...
      {/* Content */}
      <div className="flex-1 flex flex-col md:flex-row items-center justify-between px-4 md:px-16 pt-24 pb-8 gap-10">

        {/* Colonne gauche — ton texte inchangé */}
        ...
        <div className="flex items-center justify-center shrink-0">
          <div className="relative">
            ...
            <div className="absolute inset-0 rounded-full border border-dashed border-[#00e5ff]/10 scale-125" />

            {/* Photo */}
            <div className="w-52 h-52 md:w-64 md:h-64 rounded-full overflow-hidden border-2 border-[#00e5ff]/40 relative z-10">
              <img
                src="/images/profile.png"
                alt="RAELISON Andriatina Hermann"
                className="w-full h-full object-cover object-top"
              />
            </div>

            {/* Badge disponible */}
            <div className="absolute bottom-2 right-2 z-20 bg-[#080c10] border border-[#00e5ff]/40 px-2 py-1 flex items-center gap-1.5">
              <div className="w-1.5 h-1.5 rounded-full bg-[#00e5ff]" />
              <span className="text-[8px] text-[#00e5ff] tracking-widest uppercase">Disponible</span>
            </div>
          </div>
        </div>
      ...
      {/* Footer hint — tes liens inchangés */}
